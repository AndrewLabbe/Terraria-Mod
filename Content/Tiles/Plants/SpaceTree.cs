...
{
	public class SpaceTree : ModTree
	{
		...
		public override void SetStaticDefaults() {
			...
			GrowsOnTileId = new int[1] { ModContent.TileType<SpaceDirt>() };
			texture = ModContent.Request<Texture2D>("VoyagerMod/Content/Tiles/Plants/SpaceTree");
			branchesTexture = ModContent.Request<Texture2D>("VoyagerMod/Content/Tiles/Plants/SpaceTree_Branches");
			topsTexture = ModContent.Request<Texture2D>("VoyagerMod/Content/Tiles/Plants/SpaceTree_Tops");
		}
		...
		public override int SaplingGrowthType(ref int style) {
			style = 0;
			return ModContent.TileType<Plants.SpaceSapling>();
		}
