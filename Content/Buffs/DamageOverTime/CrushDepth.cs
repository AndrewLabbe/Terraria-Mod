...
namespace VoyagerMod.Content.Buffs.DamageOverTime
{
    public class CrushDepth : ModBuff
    {
        ...
        {
            player.Voyager().cDepth = true;
        }

        public override void Update(NPC npc, ref int buffIndex)
        {
            if (npc.Voyager().cDepth < npc.buffTime[buffIndex])
                npc.Voyager().cDepth = npc.buffTime[buffIndex];
