...
{
	public class SpaceDirt : ModItem
	{
		...
		public override void SetDefaults() {
			Item.DefaultToPlaceableTile(ModContent.TileType<Tiles.SpaceDirt>());
			Item.width = 12;
			Item.height = 12;
		}
        ...
        */
		...
		public override void ExtractinatorUse(int extractinatorBlockType, ref int resultType, ref int resultStack) { // Calls upon use of an extractinator. Below is the chance you will get ExampleOre from the extractinator.
			if (Main.rand.NextBool(3)) {
				resultType = ModContent.ItemType<MalachiteOre>();  // Get this from the extractinator with a 1 in 3 chance.
