...
{
    public class InterstellarSword : ModItem, ILocalizedModType
    {
        ...
        public override bool Shoot(Player player, EntitySource_ItemUse_WithAmmo source, Vector2 position, Vector2 velocity, int type, int damage, float knockback)
        {
            ...
            // Center projectile
            int centerID = ModContent.ProjectileType<InterstellarSwordMain>();
            ...
            int sideID = ModContent.ProjectileType<InterstellarSwordSide>();
        ...
        private void OnHitEffects(Player player, Vector2 targetPos)
        {
            ...
            int numSplits = 5;
            int trueMeleeID = ModContent.ProjectileType<InterstellarSwordHoming>();
