    ...
    public class Nuke : ModProjectile, ILocalizedModType
    {
        ...
        public override void AI()
        {
            ...
            if (flarePowderTimer <= 0)
            {
                ...
                {
                    Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center, Vector2.Zero, ModContent.ProjectileType<InterstellarBombardierDustProjectile>(), (int)(Projectile.damage * 0.5), Projectile.knockBack, Projectile.owner, 0f, 0f);
                }
                flarePowderTimer = 12;
            }
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            if (Main.netMode != NetmodeID.Server)
            {
                ...
                for (int goreIndex = 0; goreIndex < goreAmt; goreIndex++)
                {
                    ...
                    Mod mod = ModContent.GetInstance<VoyagerMod>();
