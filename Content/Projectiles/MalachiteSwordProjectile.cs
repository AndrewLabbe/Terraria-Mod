...
namespace VoyagerMod.Content.Projectiles
{
	...
	public class MalachiteSwordProjectile : ModProjectile
	{
		...
		public override string Texture => "VoyagerMod/Content/Items/MalachiteSword"; // Use texture of item as projectile texture
