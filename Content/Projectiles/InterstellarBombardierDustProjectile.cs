...
{
    public class InterstellarBombardierDustProjectile : ModProjectile, ILocalizedModType
    {
        public new string LocalizationCategory => "Projectiles.Ranged";
        public override string Texture => "VoyagerMod/Content/Projectiles/InvisibleProj";
